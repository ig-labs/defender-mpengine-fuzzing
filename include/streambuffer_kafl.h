...
typedef struct _STREAMBUFFER_DESCRIPTOR {
    FILE   *UserPtr;
    ULONG64  (* Read)(FILE *fp, uint64_t Offset, PVOID Buffer, DWORD Size, PDWORD SizeRead);
    ULONG64  (* Write)(FILE *fp, uint64_t Offset, PVOID Buffer, DWORD Size, PDWORD TotalWritten);
    ULONG64  (* GetSize)(FILE *fp, uint64_t *FileSize);
    ULONG64  (* SetSize)(FILE *fp, uint64_t *FileSize);
    PWCHAR (* GetName)(FILE *fp);
    ULONG64  (* SetAttributes)(FILE *fp, DWORD Attribute, PVOID Data, DWORD DataSize);
    ULONG64  (* GetAttributes)(FILE *fp, DWORD Attribute, PVOID Data, DWORD DataSize, PDWORD DataSizeWritten);
